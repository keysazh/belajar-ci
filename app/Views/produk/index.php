    ...
    <tbody>
        <?php foreach ($products as $index => $produk) : ?>
            <tr>
                ...
                <td>
                    <!-- Tombol Ubah memanggil #editModal-ID -->
            ...
            <!-- PINDAH KE SINI: Modal edit harus di-include di dalam foreach agar mendapatkan variabel $produk -->
...
<!-- Modal add tetap di luar karena tidak butuh loop data produk -->
